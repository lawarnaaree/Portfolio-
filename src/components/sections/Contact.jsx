...
const Contact = () => {
    ...
    const contactInfo = [
        ...
        },
        {
            ...
            label: 'LinkedIn',
            value: 'Lawarna Aree',
            link: 'https:/linkedin.com/in/lawarna-aree-032180317'
        }
    ];
                    ...
                    <div className="contact-info">
                        ...
                        <div className="contact-socials">
                            ...
                            <div className="socials-links">
                                <a href="https://github.com/lawarnaaree" target="_blank" rel="noopener noreferrer" className="social-btn hoverable">
                                ...
                                <a href="https:/linkedin.com/in/lawarna-aree-032180317" target="_blank" rel="noopener noreferrer" className="social-btn hoverable">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                                    </svg>
                                </a>
                                <a href="https://www.instagram.com/ar33_s" target="_blank" rel="noopener noreferrer" className="social-btn hoverable">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M7.75 2h8.5A5.75 5.75 0 0 1 22 7.75v8.5A5.75 5.75 0 0 1 16.25 22H7.75A5.75 5.75 0 0 1 2 16.25V7.75A5.75 5.75 0 0 1 7.75 2m0 1.5A4.25 4.25 0 0 0 3.5 7.75v8.5A4.25 4.25 0 0 0 7.75 20.5h8.5A4.25 4.25 0 0 0 20.5 16.25V7.75A4.25 4.25 0 0 0 16.25 3.5zM12 7a5 5 0 1 1 0 10 5 5 0 0 1 0-10m0 1.5a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7m6.375-1.5a1.125 1.125 0 1 1 0-2.25 1.125 1.125 0 0 1 0 2.25" />
                                    </svg>
                                </a>
                            </div>
                        </div>
