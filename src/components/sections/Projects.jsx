...
const Projects = () => {
    ...
    useEffect(() => {
        ...
        // Initial entrance animation - only run once
        if (!hasEntered.current) {
            ...
            // Already in view, just animate the new cards directly
            gsap.fromTo(cards,
                { opacity: 0, y: 30 },
                {
                    opacity: 1, y: 0,
        ...
        return () => {
            // No need to kill global triggers, just this component's if necessary
        };
    }, [activeFilter]);
